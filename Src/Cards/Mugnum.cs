...
public class Mugnum(): CardAbstract(1,CardType.Attack,CardRarity.Common,TargetType.AnyEnemy,true)
{
    public string cardID = "mugnum";
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
        ...
        await PowerCmd.Apply<AimStylePower>(cardPlay.Target,DynamicVars.Damage.IntValue,Owner.Creature,this);
	}
