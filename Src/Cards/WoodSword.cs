...
public class WoodSword():CardAbstract(1,CardType.Attack,CardRarity.Common,TargetType.AnyEnemy,true)
{
    public string cardID = "WoodSword";
    public override string PortraitPath => $"{cardImgPathRoot}/wood_sword.png";    //卡图   
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
        ...
        await PowerCmd.Apply<GrassStylePower>(cardPlay.Target,DynamicVars.Damage.IntValue,Owner.Creature,this);
